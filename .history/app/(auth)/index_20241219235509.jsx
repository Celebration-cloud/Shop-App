...
const LoginScreen = () => {
  ...
  const handleLogin = (user) => {
    router.navigate({pathname: "(home)", params: {session: `${user.email}logged in Successfully`}})
    console.log('Data:', `${user.email}logged in Successfully`)const handleSignupSwitch = () => { 
