...
const LoginScreen = () => {
  ...
  return (
    <View style={styles.container}> <View style={styles.content}> <View style={styles.logoContainer}> <Image resizeMode="cover" source={require('../../assets/images/shop-app-logo.png')} style={{ position: 'relative', width: '100%', height: '100%' }} /> </View>
  );
}
