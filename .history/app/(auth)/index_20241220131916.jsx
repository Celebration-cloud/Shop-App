...
const styles = StyleSheet.create({
  ...
  toast: { position: 'absolute', bottom: 20, left: '10%', right: '10%', backgroundColor: 'red', padding: 10, borderRadius: 5, justifyContent: 'center', alignItems: 'center', }, toastText: { color: 'white', fontSize: 14, },
});