      ...
      <View style={styles.content}>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={styles.alt}>
            Dont't have an account? <Pressable onPress={handleSignupSwitch} style={{justifyContent: "center", alignItems: "center"}}><Text style={styles.hlt}>Sign up</Text></Pressable>
          </Text>
        </View>
      </View>
    </View>
