...
export default function Index() {
  ...
  return (
    ...
    >
      ...
      />
      <FlatListCard data={shopItems} handleAddToCart={handleAddToCart} handleDetails={handleDetails} btnLeftTitle="DETAILS" btnRightTitle={loading ? <Ionicons name="loa"/> : "ADD TO CART"}/>
    </View>
  );
}
