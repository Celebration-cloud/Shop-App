  ...
  const colorMode = useColorScheme()
   const dispatch = useDispatch();
    ...
    useEffect(() => {
       ...
       navigation.addListener("focus", fetchShoppingItems, fetchCartItems);
       navigation.addListener("focus", fetchShoppingItems, fetchCartItems);

      return () => {
        navigation.removeListener("focus", fetchShoppingItems, fetchCartItems);
        navigation.removeListener("focus",  fetchCartItems);
      };
    }, [fetchShoppingItems, fetchCartItems]);
