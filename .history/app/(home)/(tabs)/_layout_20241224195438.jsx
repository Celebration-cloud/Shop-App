...
const TabsLayout = () => {
 ...
 const fetchItems = useCallback(() => { dispatch(getShopItems(token)); dispatch(getCartItems(token, user)); console.log('done'); }, [dispatch, token, user]); useFocusEffect( useCallback(() => { fetchItems(); }, [fetchItems]) );
