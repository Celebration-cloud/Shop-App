...
const TabsLayout = () => {
  ...
  useEffect(() => {
    navigation.addListener("", fetchCartItems);
    return () => {
      navigation.removeListener("", fetchCartItems);
    };
  }, [fetchCartItems]);

  useEffect(() => {
    navigation.addListener("", fetchShoppingItems);

    return () => {
      navigation.removeListener("", fetchShoppingItems);
    };
  }, [fetchShoppingItems]);
