...
const TabsLayout = () => {
  ...
  useEffect(() => {
    navigation.addListener("fo", fetchCartItems);
    return () => {
      navigation.removeListener("fo", fetchCartItems);
    };
  }, [fetchCartItems]);

  useEffect(() => {
    navigation.addListener("fo", fetchShoppingItems);

    return () => {
      navigation.removeListener("fo", fetchShoppingItems);
    };
  }, [fetchShoppingItems]);
