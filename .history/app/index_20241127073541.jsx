...
export default function Index() {
  ...
  const handleAddToCart = (data) => {
    ...
    const handleDetails = (data) => { 
      console.log(data) 
      router.navigate({pathname: `/details/[]`, params: {name: data.name, description: data.description, url: data.imageUrl, price: data.price, id: data.id, category: data.category}});
    };
