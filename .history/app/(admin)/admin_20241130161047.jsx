...
const AdminScreen = () => {
  ...
  return (
    <View>
      <FlatListCard data={shopItems} handleLeftButton={handleEdit} handleRightButton={Alert.alert("Confirmation", "Are you sure you want to make this change?", [{onPress: handleDelete, style: "cancel"}])} btnLeftTitle="EDIT" btnRightTitle="DELETE"/>
    </View>
  )
}
