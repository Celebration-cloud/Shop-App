  ...
  const dispatch = useDispatch()
    ...
    const handleConfirm = () => { 
      Alert.alert(
        ...
        [{ onPress: handleDelete, style: "cancel" }]
      );
     };
  return (
    <View>
      <FlatListCard data={shopItems} handleLeftButton={handleEdit} handleRightButton={handleCo} btnLeftTitle="EDIT" btnRightTitle="DELETE"/>
    </View>
  )
}
