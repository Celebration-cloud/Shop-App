...
import {addShopItem, editShopItem, getShopItems} from '../../../store/actions/shopActions'
...
const EditOrAddScreen = () => {
  ...
  const router = useRouter();
     ...
     const fetchShoppingItems = useCallbac(() => {
  ...
  const onSubmit = (addProduct) => {
    if(dataItem){
      ...
      dispatch(editShopItem(dataItem.id, editData))
      router.dismiss()
    }else if(!dataItem){
        ...
        <View>
          ...
          <Controller
            ...
            rules={{
              ...
              maxLength: {
                value: 90,
                message: "Name must be below 90 characters",
              },
            }}
            render={({ field: { onChange, onBlur, value } }) => (
              <TextInput
