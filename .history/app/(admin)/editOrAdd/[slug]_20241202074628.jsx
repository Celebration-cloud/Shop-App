    ...
    <View>
      ...
      <View style={styles.formContainer}>
        ...
        <View>
          ...
          id: dataItem ? dataItem.id : Date.now(), name: dataItem ?
          dataItem.name : "", description: dataItem ? dataItem.description : "",
          price: dataItem ? dataItem.price : Number, category: dataItem ?
          dataItem.category : "", imageUrl: dataItem ? dataItem.imageUrl : "",
          <TextInput
            style={styles.input}
