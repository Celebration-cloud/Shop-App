          ...
          <Fragment>
            <View>
              ...
              <Controller
                ...
                name="price"
              />
              {errors.price && <Text> Must be a number</Text>}
              <TextInput
                style={styles.input}
            ...
            <View>
              ...
              <Controller control={control} name="category" rules={{ required: true }} render={({ field: { onChange, value } }) => ( <Picker selectedValue={value} onValueChange={(itemValue) => onChange(itemValue)} style={styles.category} > {categoryData.map((item, idx) => ( <Picker.Item key={idx} label={item} value={item} /> ))} </Picker> )} /> {errors.category && <Text>This is required.</Text>}
              <Picker
