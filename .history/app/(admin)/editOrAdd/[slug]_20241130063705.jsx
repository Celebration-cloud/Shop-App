      ...
      <View>
        ...
        <View>
          ...
          >
            ...
            <Picker.Item label={categoryData[1]} value={categoryData[0]} />
            <Picker.Item label={categoryData[2]} value={categoryData[0]} />
            <Picker.Item label={categoryData[3]} value={categoryData[0]} />
          </Picker>
        </View>
      </View>
    </View>
