...
const List = ({data, onPressLeft, onPressRight}) => {
...
const cardComponent = (itemData, props) => {
  return <List data={itemData.item} onPressLeft={itemData.item.onPressLeft} onPressRight={itemData.item.onPressRight}/>
}
