...
export const addToCart = (userData, user) => async (dispatch, getState) => {
    try {
        dispatch({ type: "LOADING", payload: true})
         const response = await axios.get(`${SHOP_API}/api/shopItem/ const response = await axios.get(`${SHOP_API}/api/shopItem/user/get`, {params: {idToken: token}});`, {
